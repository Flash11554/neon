...
Hansı mövzuda köməyə ehtiyacınız varsa, dəstək söhbətində suallarınızı verin.Bütün əmrlər belə istifadə oluna bilər: /.format(SUPPORT_CHAT), reply_markup=keyboard
        )
    else:
        try:
            await update.delete()
