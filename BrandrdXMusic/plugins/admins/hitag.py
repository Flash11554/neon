...
TAGMES = [ "🤩 Sabahınız xeyir Yeni gün sizə sevinc və uğur gətirsin! Hər anınız gözəl keçsin! 🌸✨",
"☀️ Sabahınız xeyir.Hər gün yeni bir ümiddir. Bu gün də arzularınıza çatmaq üçün möhtəşəm bir fürsətdir! 🌟😊",
"🌸 Sabahınız xeyir.Gülümsəyin və gözəl bir günə hazır olun. Bu gün də hər şey ürəyinizcə olsun! 💕💪",
"☕ Sabahınız xeyir.Çayınızı/Qəhvənizi alın və enerjinizi yüksəldin! Bugün sizin üçün çox uğurlu olacaq! 🌺🔥",
"🦋 Sabahınız xeyir. Yeni başlanğıclar, yeni şanslar sizi gözləyir. Pozitiv olun və hər anı dəyərləndirin! 🌈✨",
          ]
