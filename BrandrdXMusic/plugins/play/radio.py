...
RADIO_STATION = {
    "Airlines": "http://air.pc.cdn.bitgravity.com/air/live/pbaudio110/playlist.m3u8",
    "Radio 1": "http://air.pc.cdn.bitgravity.com/air/live/pbaudio118/playlist.m3u8",
    ...
    "Forbs": "http://peridot.streamguys.com:7150/Mirchi",
    "Radio Today": "http://stream.zenolive.com/8wv4d8g4344tv",
    "YouTube": "https://www.youtube.com/live/eu191hR_LEc?si=T-9QYD548jd0Mogp",
    "My News": "https://www.youtube.com/live/TPcmrPrygDc?si=hiHBkIidgurQAd1P",
    "010 News": "https://www.youtube.com/live/Nq2wYlWFucg?si=usY4UYiSBInKA0S1",
}
...
async def radio(client, message: Message):
    msg = await message.reply_text("Zehmət olmasa biraz gözləyin....")
    try:
        try:
        ...
        try:
            ...
            try:
                ...
                return await msg.edit(
                    f"ᴅəᴠəᴛ ᴇᴅə ʙɪʟᴍəᴅɪ {userbot.mention} ᴋöᴍəᴋçɪɴɪ {message.chat.title}.\n\n**ʀᴇᴀsᴏɴ :** `{ex}`"
                )
        except Exception as ex:
            if "channels.JoinChannel" in str(ex) or "Username not found" in str(ex):
                return await msg.edit_text(
                    f"» ɪ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ᴘᴇʀᴍɪssɪᴏɴs ᴛᴏ ɪɴᴠɪᴛᴇ ᴜsᴇʀs ᴠɪᴀ ʟɪɴᴋ ғᴏʀ ɪɴᴠɪᴛɪɴɢ {userbot.mention} ᴋöᴍəᴋçɪɴɪ {message.chat.title}."
                )
            else:
                return await msg.edit_text(
                    f"ᴅəᴠəᴛ ᴇᴅə ʙɪʟᴍəᴅɪ {userbot.mention} ᴋöᴍəᴋçɪɴɪ {message.chat.title}.\n\n**ʀᴇᴀsᴏɴ :** `{ex}`"
